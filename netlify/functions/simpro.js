...
//   SIMPRO_BUILD  (subdomain, e.g. "firstair" for firstair.simprosuite.com)
//   SIMPRO_COMPANY (default 0)
//   SIMPRO_TOKEN  (API access token)  OR  SIMPRO_CLIENT_ID + SIMPRO_CLIENT_SECRET (OAuth2 client credentials)
